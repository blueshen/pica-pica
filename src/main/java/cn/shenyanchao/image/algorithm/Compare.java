...
import cn.shenyanchao.image.filters.JPEGFilter;
import cn.shenyanchao.image.general.ImageSimilarity;
import cn.shenyanchao.image.general.UserInterface;
import cn.shenyanchao.image.utils.ImageHolder;
...
public class Compare extends Thread
{
	 ...
	 * 
	 * @see cn.shenyanchao.image.utils.ImageHolder
	 * @return
	 * 
	 * @author Grzegorz Polek <grzegorz.polek@gmail.com>
	 */
